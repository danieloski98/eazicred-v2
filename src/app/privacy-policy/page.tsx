    ...
    <AppFrame active="home">
      <section className="space-y-6">
        <SectionIntro
          ...
          description="We are committed to protecting and respecting your privacy."
        />
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          <div className="space-y-4 text-sm leading-7 text-slate-500">
            <p>
              ...
              sets out the basis on which any personal data we collect from you, or
              that you provide to us, will be processed by us. Please read the
              following carefully to understand our views and practices regarding
              your personal data and how we will treat it.
            </p>
            <p>
              By visiting “www.eazicred.com” (“our site”) you are accepting and
              consenting to the practices described in this policy. Please note that
              by clicking the “Connect with Facebook” button you are agreeing that
              Facebook may share personal data held by them with us.
            </p>
            <p>
              ...
              “Regulations”) and the provisions and prescriptions of Section 5; Part
              1 and Part 2 of National Information Systems and Network Security.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <h4 className="mt-6 text-base font-semibold text-slate-950">
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            <p>
              ...
              www.eazicred.com and by allowing us to access your information on
              social media sites (including but not limited to Facebook, Twitter,
              Instagram and LinkedIn) or by corresponding with us by phone, e-mail
              or otherwise.
            </p>
            <p>
              This includes information you provide when you register to use our
              site, apply for a loan, search for a feature (for example but not
              limited to, loan amounts, currency, loan duration), your activity
              levels on boards or other social media functions on the applicable
              social media sites, the applications you use on social media sites,
              and when you report a problem with our site.
            </p>
            <p>
              The information you give us may include your name, address, e-mail
              address and phone number, login information for social networking
              sites, financial and credit card information, personal description,
              current and former places of employment, education, names of
              colleagues, contacts and friends, photographs, and lists of family
              members.
            </p>
          </div>
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            <p>
              ...
              collect the following information: technical information, including
              the Internet protocol (IP) address used to connect your computer to
              the Internet, your login information, browser type and version, time
              zone setting, browser plug-in types and versions, operating system and
              platform.
            </p>
            <p>
              Information about your visit, including the full Uniform Resource
              Locators (URL) click stream to, through and from our site (including
              ...
              used to call our customer service number anonymize repayment data.
            </p>
          </div>
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            <p>
              ...
              websites we operate, the other services we provide and/or the social
              media sites which you login to via our site.
            </p>
            <p>
              ...
              delivery services, social media sites, advertising networks, analytics
              providers, search information providers, credit bureaus, and financial
              services and credit providers) and may receive information about you
              from them.
            </p>
          </div>
        </div>
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            ...
            <p>
              By visiting our website, you consent to the placement of cookies and
              beacons in your browser and HTML-based emails in accordance with this
              Privacy Policy. We use information held about you in the following
              ways:
            </p>
          </div>
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            ...
            <p>
              To establish a credit rating based on your information and provide
              that rating to third parties who may be interested in offering you
              financial products and services and this information is provided only
              to third parties selected by you or where you have agreed that we may
              share your score and information with;
            </p>
            <p>
              To provide you with information about other goods and services we
              offer that are similar to those that you have already purchased or
              enquired about anonymize repayment data subject to the marketing
              preferences you have selected on our website, to provide you, or
              permit selected third parties to provide you, with information about
            ...
            <p>
              ...
              services similar to those which were the subject of a product or
              service which you were previously interested in.
            </p>
            <p>
            ...
            <p>
              (a). To notify you about changes to our service; (b). To ensure that
              content from our site is presented in the most effective manner for
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            <p>
              We collect this information to establish a credit rating based on
              your information and provide that rating to third parties who may be
              interested in offering you financial products and services; We may
              combine this information with information you give to us and
              information we collect about you.
            </p>
            <p>
              We may use this information and the combined information for the
              purposes set out above (depending on the types of information we
              receive). We may carry out a further processing of your data for
        ...
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            ...
            <p>
              ...
              of any contract we enter into with them or you. Advertisers and
            ...
            <p>
              We may also use such aggregate information to help advertisers reach
              the kind of audience they want to target (for example, women in Lagos
              State). We may make use of the personal data we have collected from
              you to enable us to use Analytics and search engine providers that
              assist us in the improvement and optimization of our site. We may
            ...
            <p>
              b) If Eazicred LTD substantially all of its assets are acquired by a
            ...
            <p>
              ...
              property, or safety of Eazicred LTD, our customers, or others. This
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-500">
            ...
            to enable us to use the information in accordance with this policy. Any
            such information transferred to other countries shall be in compliance
        ...
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            <p>
              ...
              that: We can provide materials and other information about your legal
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            ...
            <p>
              We ask you not to share a password with anyone. Unfortunately, the
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-500">
            ...
            fulfill the purposes outlined in this privacy policy. Even if we
            delete your data, it may persist on backup or archival media for legal,
        ...
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <div className="mt-3 space-y-4 text-sm leading-7 text-slate-500">
            ...
            <p>
              ...
              intend to use your data for the aforementioned purposes or if we
            ...
            <p>
              You can also exercise the right at any time by contacting us via
              email at contact@eazicred.com. Our site may, from time to time,
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-500">
            ...
            damages caused by any breach of the provisions herein and to exercise
            all other rights existing under law. Any claim or dispute arising in
            relation to this privacy policy shall be subject to the jurisdiction
            of the courts of the Federal Republic of Nigeria. We shall not be
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-500">
            ...
            Eazicred LTD, its affiliates, officers, directors, employees,
            attorneys or agents shall have any liability with respect to, and you
            hereby waive, release and agree not to sue any of them upon, any claim
            for any special, indirect, incidental, consequential damages suffered
            or incurred by you in connection with, arising out of, or in any way
      ...
      <section className="space-y-6">
        <div className="soft-shadow rounded-[24px] bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-500">
            Questions and requests regarding this privacy policy are welcomed.
          </p>
        </div>
      </section>
    </AppFrame>
